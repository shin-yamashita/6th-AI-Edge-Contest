...
# tfacc pin assign
set_property -dict { PACKAGE_PIN D7   IOSTANDARD LVCMOS18 }   [get_ports {pout_0[7] }];  # "D7.HD_GPIO_0"
set_property -dict { PACKAGE_PIN F8   IOSTANDARD LVCMOS18 }   [get_ports {TXD_0     }];  # "F8.HD_GPIO_1"
set_property -dict { PACKAGE_PIN F7   IOSTANDARD LVCMOS18 }   [get_ports {RXD_0     }];  # "F7.HD_GPIO_2"
set_property -dict { PACKAGE_PIN G7   IOSTANDARD LVCMOS18 }   [get_ports {pout_0[0] }];  # "G7.HD_GPIO_3"
set_property -dict { PACKAGE_PIN F6   IOSTANDARD LVCMOS18 }   [get_ports {pout_0[1] }];  # "F6.HD_GPIO_4"
set_property -dict { PACKAGE_PIN G5   IOSTANDARD LVCMOS18 }   [get_ports {pout_0[2] }];  # "G5.HD_GPIO_5"

set_property -dict { PACKAGE_PIN E5   IOSTANDARD LVCMOS18 }   [get_ports {pout_0[3]  }];  # "E5.HD_GPIO_10"
set_property -dict { PACKAGE_PIN D6   IOSTANDARD LVCMOS18 }   [get_ports {pout_0[4]  }];  # "D6.HD_GPIO_11"

set_property -dict { PACKAGE_PIN A6   IOSTANDARD LVCMOS18 }   [get_ports {fp_0[0]  }];  # "A6.HD_GPIO_6"
set_property -dict { PACKAGE_PIN A7   IOSTANDARD LVCMOS18 }   [get_ports {fp_0[1]  }];  # "A7.HD_GPIO_7"

set_property -dict { PACKAGE_PIN G6   IOSTANDARD LVCMOS18 }   [get_ports {pout_0[5] }];  # "G6.HD_GPIO_8"
set_property -dict { PACKAGE_PIN E6   IOSTANDARD LVCMOS18 }   [get_ports {pout_0[6] }];  # "E6.HD_GPIO_9"

###set_property -dict { PACKAGE_PIN D5   IOSTANDARD LVCMOS18 }   [get_ports {fp_0[1]   }];  # "D5.HD_GPIO_12"
set_property -dict { PACKAGE_PIN C7   IOSTANDARD LVCMOS18 }   [get_ports {fp_0[2]   }];  # "C7.HD_GPIO_13"
set_property -dict { PACKAGE_PIN B6   IOSTANDARD LVCMOS18 }   [get_ports {fp_0[3]   }];  # "B6.HD_GPIO_14"
set_property -dict { PACKAGE_PIN C5   IOSTANDARD LVCMOS18 }   [get_ports {fp_0[4]   }];  # "C5.HD_GPIO_15"
...
connect_debug_port dbg_hub/clk [get_nets design_1_i/zynq_ultra_ps_e_0_pl_clk0 ]
